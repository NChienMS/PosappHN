...
window.onload = function()
{
 ...
 function verify(){if (document.querySelector('#password').value === '61030091'){document.querySelector('.sonblogloginwrap').classList.add('hidden');window.open("internal.html","_self");}
